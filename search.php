<html>
    ...
    <body>
        ...
        <div class="form-group">
            ...
            <select class="form-control demo-default" name="blood_group" id="blood_group" required>
          ...
          <script>
            ...
            "TamilNadu":["Ariyalur","Chennai","Coimbatore","Cuddalore","Dharmapuri","Dindigul","Erode","Kanchipuram","Kanyakumari","Karur","Krishnagiri","Madurai","Nagapattinam","Namakkal","Nilgiris","Perambalur","Pudukkottai","Ramanathapuram","Salem","Sivaganga","Thanjavur","Theni","Thoothukudi","Tiruchirappalli","Tirunelveli","Tenkasi","Tiruppur","Tiruvallur","Tiruvannamalai","Tiruvarur","Vellore","Viluppuram","Virudhunagar"],
            ...
            <button name="Search"><i class="fa fa-search"></i>Submit</button>
